        ...
        <Grid container direction="row">
          <Grid item>
            <Typography variant="body1" color="lightgray">
              I'm a frontend developer, a musician, and a mentor. I currently work as a Software Engineer at &nbsp;
              <Chip
                avatar={
                  <img
                    src={SmudgeLogo}
      ...
      {tabValue === "tech" && (
        <>
         <Grid item xs={9} lg={7}>
          ...
          <Grid item xs={9} lg={7}>
            <Typography variant="body1" color="lightgray">
              Over the past few years, I've dedicated my efforts to building web
              applications for various industries like logistics at
              Entrego, bottling at Coke CONA, and merchandising
              industry at UrStore while greatly improving my skills along
              the way.
            </Typography>
          </Grid>
          ...
          <Grid item xs={9} lg={7}>
            <Typography variant="body1" color="lightgray">
              Beyond coding, I actively perform with my string quartet, and help a community I built made up of friends and peers
